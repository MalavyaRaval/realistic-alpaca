"""Injects artifact_data.json into artifact_template.html - a file-level
string substitution so the data payload never needs to pass through
anything other than disk I/O."""
